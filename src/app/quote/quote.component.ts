...
export class QuoteComponent implements OnInit {
  ...
  quotes: Quote[] = [
    ...
    new Quote(3, 'The only impossible journey is the one you never begin.', 0, 0, 'Tony Robbins','Mercy',  new Date(2022,4,11)),
    ...
    new Quote(5, 'You will face many defeats in life, but never let yourself be defeated.', 0, 6, 'Maya Angelou','Mercy', new Date(2022,4,9) ),
  ];
